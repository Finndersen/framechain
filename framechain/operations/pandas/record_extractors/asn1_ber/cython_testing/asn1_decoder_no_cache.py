...
class Asn1Decoder(object):
    ...
    def traverse_asn(self, node, current_record=None):
        ...
        if current_record is not None:
            ...
            elif (node.type == 0) and (node.id in self.current_record_schema.target_fields):
        ...
        if node.parent:
            ...
            elif node.parent.end_pos is None:
...
class ASN1Node(object):
    ...
    __slots__ = ['start_pos','value_pos','end_pos', 'asn_data', 'type', 'parent', 'id']

    def __init__(self, start_pos, tag_len, value_len, tag_type, parent_node, tag_number):
        """
