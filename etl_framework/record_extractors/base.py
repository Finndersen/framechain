...
from etl_framework.operations.transforms import ToInteger
import logging
...
class BaseRecordExtractor(BaseOperation):
    ...
    Must define 'build_raw_dataframe' method which takes ETL input parameter and produces DataFrame with raw field values
    ...
    def __call__(self, etl_input):
        ...
        with LogDuration(log, 'Extracting records from input...'):
            dataframe = self.build_raw_dataframe(etl_input)
    ...
    def build_raw_dataframe(self, etl_input):
        """
