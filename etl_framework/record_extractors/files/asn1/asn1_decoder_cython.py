...
from .asn1_decoder import Asn1Decoder
from etl_framework.record_extractors.files.asn1.asn1_decoder_extensions import decode_tag

class ASN1CythonDecoder(Asn1Decoder):
    """
