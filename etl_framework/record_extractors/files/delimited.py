...
class DelimitedRecordExtractor(FileRecordExtractor):
    """
    ...
    def __init__(self, file_reader, fields, delimiter=',', quoting=csv.QUOTE_MINIMAL, header=True, **read_csv_kwargs):
        """
...
class TimestampField(CSVField):
    def __init__(self, name, format, **kwargs):
        converter = StringToDatetime(format, vectorised=False)
